...
data <- read_csv("Josie/Data/DraftData_20211021.csv")%>%
...
all_data_centroidkiller_questquecest <- all_data_coords3 %>%
  mutate("lat_long" = str_c(Latitude, Longitude, sep = ", "))

# Write the cleaned up spatial data to a file
write_csv(all_data_coords3, "Josie/Data/DraftData_20211021_SpatialClean.csv")
