...
This is an R Markdown for the TNC Gap Analysis to complete the synonymy for Aves. DAK has done the Cal-IBIS and SBMNH synonymy. Using lists created from her completed synonymy this code will complete the synonymy for the iNaturalist and eBird datasets. Then a second round was done with the synonymy list she provided. 

9/3 Another round of synonymy updates for the SBMNH datasets which are new (not all the SBMNH was previously included)
...
# R3 Synonymy 9/3/21 Uploading and doing the synonymy for the new SBMNH datasets 
```{r}
#add synonymy lists
aves_syn = read_csv("Aves/aves_syn.csv")
aves_syn2 = read_csv("Aves/aves_syn2.csv")
