...
aves_sbmnh_col <- read_csv("aves/aves_sbmnh_col5.csv")
...
aves_ebird_new <- aves_ebird_empid %>%
...
aves_ebird_ord_new <- aves_ebird_empid %>%
  rename(latitude = "decimalLatitude", longitude="decimalLongitude", island="island...127", scientificName="scientificName...202") %>%
...
ggsave(plot=aves_h_year, filename="aves/AvesGraphs/aves_H_yearp.png", height=30, width=35, units="cm", dpi=300)
```
```{r bird H island}
...
ggsave(plot=aves_h_island, filename="aves/AvesGraphs/aves_H_islandp.png", height=30, width=35, units="cm", dpi=300)
```
