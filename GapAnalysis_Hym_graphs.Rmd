...
inat =read.csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_inat_clean.csv")
lacm = read.csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_lacm_clean.csv")
chis = read_csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_chis_clean.csv")
bohart = read.csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_bohart_clean.csv")
bold = read.csv("~/gitit/TNC Gap Analysis/hymenoptera/BOLD_IslandHymenoptera_Feb2021.csv")
```
...
```{r synonymy dataset}
mastersyn = read.csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_master_syn.csv")
...
occyear = ggplot(mastersyn, aes(x=year, fill=source)) + geom_bar() + theme_bw() + scale_y_continuous(expand=c(0,0)) + labs(x="Year", y ="Number of Specimens Collected")
occyear
...
isoccmonth = ggplot(hymmonth, aes(x=island, fill=Month)) + geom_bar(position = "dodge", colour="black") + theme_bw() + scale_y_continuous(expand=c(0,0)) + labs(x="Collections per Island by Month", y ="Number of Specimens Collected") 
isoccmonth 
