...
plantisland <- plantisland[c(1:4034, 4247:72186),]
...
ploccyear = ggplot(plant_clean, aes(x=year, fill=island)) + geom_bar() + theme_bw() + scale_y_continuous(expand=c(0,0)) + labs(x="Year", y ="Number of Specimen Collected")
ploccyear = ploccyear + scale_x_continuous(limits = c(1860, 2020), expand=c(0,0), breaks=c(1880, 1900, 1920, 1940, 1960, 1980, 2000, 2019))
ploccyear
...
ploccyear2 = ploccyear2 + scale_x_continuous(limits= c(1860, 2020), expand=c(0,0), breaks=c(1880, 1900, 1920, 1940, 1960, 1980, 2000, 2019))
ploccyear2
...
plant_bar + labs(x="Phylum", y ="Number of Specimen Collected") + scale_y_continuous(expand=c(0,0))
