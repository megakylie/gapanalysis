...
orth_inat_messy = read_csv("orthoptera/orth_inat.csv") %>%
...
```{r}
orth_syn_list_complete = read_csv("Orthoptera/orth_syn_list_comp.csv")
...
write.csv(orth_inat2, "Orthoptera/orth_inat2.csv", na="")
...
write.csv(hem_inat2, "hemiptera/hem_inat2.csv", na="")

hem_chis2 <- left_join(hem_chis1, hem_syn_round2)
write.csv(hem_chis2, "hemiptera/hem_chis2.csv", na="")

hem_bold2 <- left_join(hem_bold1, hem_syn_round2)
write.csv(hem_bold2, "hemiptera/hem_bold2.csv", na="")

hem_lacm2 <- left_join(hem_lacm1, hem_syn_round2)
write.csv(hem_lacm2, "hemiptera/hem_lacm2.csv", na="")
