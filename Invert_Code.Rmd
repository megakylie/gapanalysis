...
write.csv(mol_lit_complete, "mollusks/mol_lit_complete.csv", na="0")
...
lit_new = read_csv("new_invert_literature_R3_syninprog_Final.csv")
x_miller = read_csv("diplopoda/diplo_miller.csv") %>%
  select(acceptedFamily, acceptedGenus, acceptedName)
...
write.csv(hem_lit_complete, "Hemiptera/HemipteraGraphs/hem_lit_complete.csv", na="0")
```
...
orth_chis <- read_csv("orthoptera/orth_chis2.csv")
```
...
hym_year = ggplot(hymyear, aes(x=year, fill=source2)) + 
  ...
  labs(x="Year", y ="Number of Hymenoptera Data Points") +   scale_fill_brewer(palette = "Dark2")
