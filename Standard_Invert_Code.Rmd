...
dip_year = ggplot(dip_master, aes(x=year, fill=source)) + geom_bar() + theme_bw() + scale_y_continuous(expand=c(0,0)) + scale_x_continuous(limits=c(1910, 2025)) + labs(x="Year", y ="Number of Specimens Sampled")
dip_year
