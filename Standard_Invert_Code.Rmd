...
dip_lit <- read_csv("diptera/dip_literature.csv")
# extra for flies
...
diptab_lacm = table(dip_lacm$acceptedFamily)
...
write.csv(dip_tab_complete, "diptera/DipteraGraphs/dip_table_complete.csv", na="0")
```
...
dip_table_complete <-dip_table6 %>%
  rename(Species = "acceptedName", Family = "acceptedFamily", Genus = "acceptedGenus")

write.csv(dip_table_complete, "diptera/DipteraGraphs/dip_lit_complete.csv", na="0")

dip_complete_family = dip_table_complete %>%
...
arac_lit_fam = rbind(arac_lit_miller2, arac_lit_new)
