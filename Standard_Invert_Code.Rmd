...
#Includes: Diptera, Mollusks, Chilopoda, Diplopoda, Blattodea
...
dip_island <- ggplot(data = dip_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  ...
  labs(x ="Island", 
       y = "Number of Diptera Specimens Collected",
       fill = "Data Source") +
  theme_bw() + 
...
dip_island_prop <- ggplot(data = dip_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Diptera Specimens Collected/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
mol_island <- ggplot(data = mol_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Number of Mollusk Specimens Sampled",
       fill = "Data Source") +
  theme_bw() + 
...
mol_island_prop <- ggplot(data = mol_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Mollusk Specimens Sampled/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
chilo_island <- ggplot(data = chilo_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Number of Chilopoda Specimens Sampled",
       fill = "Data Source") +
  theme_bw() + 
  scale_x_continuous(limits =c(0,45), expand = c(0,0)) +
   scale_fill_manual(values=c("#CC3300"))
...
chilo_island_prop <- ggplot(data = chilo_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Chilopoda Specimens Sampled/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
chilo_year = ggplot(chilo_master, aes(x=year, fill=source)) + 
  ...
  labs(x="Year", y ="Number of Chilopoda Specimens Sampled") +  scale_fill_manual(values=c("#CC3300"))
...
###Diplo Step 1. Download Packages and Import Data
```{r packages}
...
diplo_island <- ggplot(data = diplo_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Number of Diplopoda Specimens Sampled",
       fill = "Data Source") +
  theme_bw() + 
...
diplo_island_prop <- ggplot(data = diplo_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Diplopoda Specimens Sampled/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
#
# Blattodea
###Bla Step 1. Download Packages and Import Data
```{r packages}
# load packages
library(tidyverse)
library(lubridate)
...
bla_island <- ggplot(data = bla_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Number of Blattodea Specimens Sampled",
       fill = "Data Source") +
  theme_bw() + 
...
bla_island_prop <- ggplot(data = bla_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Blattodea Specimens Sampled/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
#
# Odonanta
###Odo Step 1. Download Packages and Import Data
```{r packages}
# load packages
library(tidyverse)
library(lubridate)
...
odo_island <- ggplot(data = odo_islandsum, aes(x = samples, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Number of Odonata Specimens Sampled",
       fill = "Data Source") +
  theme_bw() + 
...
odo_island_prop <- ggplot(data = odo_islandprop, aes(x = by_area, y = fct_rev(island), fill = source)) + 
  geom_bar(stat = "identity") +
  labs(x ="Island", 
       y = "Odonata Specimens Sampled/Island Area (km^2)",
       fill = "Data Source") +
  theme_bw() + 
...
write.csv(diplotab, "odonata/OdonataGraphs/odo_table.csv")
