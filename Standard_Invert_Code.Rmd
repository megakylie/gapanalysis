...
hem_inat_combine <- hem_inat %>%
  ...
  select(source, month, year, island, acceptedFamily, acceptedGenus, acceptedName, latitude, longitude)

hem_chis_combine <- hem_chis %>%
  rename(latitude = "decimalLat", longitude="decimalLon") %>%
  select(source, month, year, island, acceptedFamily, acceptedGenus, acceptedName, latitude, longitude) %>% filter_all(any_vars(!is.na(.)))

hem_lacm_combine <- hem_lacm %>%
  select(source, month, year, island, acceptedFamily, acceptedGenus, acceptedName) %>%
  add_column(latitude = NA, longitude = NA)

hem_bold_combine <- hem_bold %>%
  rename(latitude = "lat", longitude = "lon") %>%
  select(source, island, acceptedFamily, acceptedGenus, acceptedName, latitude, longitude) %>%
