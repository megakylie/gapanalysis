...
bar_occurence = bar_occurence + coord_flip() + labs(x="Family", y= "")
...
bar_chis = bar_chis + coord_flip() + labs(x="Family", y= "")
...
bar_inat = bar_inat + coord_flip() + labs(x="Family", y= "")
bar_occurence
bar_chis
bar_inat
library(gridExtra)
...
unique(c(as.character(chis$family)))
# 27 fam, 173 genera, 379 unique sp. identified (only included things with a sp. id)
```
