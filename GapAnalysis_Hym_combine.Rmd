...
chis = read.csv("~/gitit/TNC Gap Analysis/hymenoptera/hym_chis_clean.csv")
...
# 20 fam, 162 genera, *** didn't do good syn 360 unique sp. identified (only included things with a sp. id)
```
